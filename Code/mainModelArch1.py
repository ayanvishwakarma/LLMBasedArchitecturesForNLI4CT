...
if __name__ == '__main__':
    ...
    for e in range(args.epochs):
        ...
        print(f"Train Loss: {train_epoch_loss[e]:20.6f} \t Val Loss: {val_epoch_loss[e]:20.6f}")
        print(f"Train Task1-Macro-F1: {train_metrics['Task1-Macro-F1']:20.6f} \t Val Task1-Macro-F1: {val_metrics['Task1-Macro-F1']:20.6f}")
        print(f"Train Task2-F1: {train_metrics['Task2-F1']:20.6f} \t Val Task2-F1: {val_metrics['Task2-F1']:20.6f}")
        print(f"Train Task1-Entailment-F1: {train_metrics['Task1-Entailment-F1']:20.6f} \t Val Task1-Entailment-F1: {val_metrics['Task1-Entailment-F1']:20.6f}")
        print(f"Train Task1-Contradiction-F1: {train_metrics['Task1-Contradiction-F1']:20.6f} \t Val Task1-Contradiction-F1: {val_metrics['Task1-Contradiction-F1']:20.6f}")
