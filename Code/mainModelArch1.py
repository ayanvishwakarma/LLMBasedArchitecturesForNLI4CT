...
if __name__ == '__main__':
    ...
    parser.add_argument('--backtranslate', action='store_true', help='Should backtranslation data-augmentation be used. Default False')
    ...
    parser.add_argument('--num_frozen_layers', default=0, type=int, 
                        help='The number of LLM lower layers to freeze if llm_finetune is true, finetuning upper layers only. Default 0')
